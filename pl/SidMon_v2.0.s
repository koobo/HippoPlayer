...
X1
	...
	* NULL CHECK, does a lot of illegal reads otherwise
	tst.l	22(a2)
	beq.b	skip 

	; d4 gets destroyed sometimes and
	; later writes go bad, save it
	push	d4
	bsr	doadsrcurve
	bsr	dowaveform
	bsr	doarpeggio
