...
msgloop2
	...
	move.b	prefs_closeSignal(a5),d1	* k�skeek� p��ohjelma lopettamaan?
	btst	d1,d0
	bne.w	exprefs
...
.id
	...
	lea	(a0,d0.l),a2		; pour tests ult�rieurs
	cmpi.l	 #$132,d0
...
.hm
	move.l	8(a0),d1
	cmpi.l	#127,d1			; nb patt : pas plus de 127, quand m�me ?
	bhi.s	.ohno
	cmpi.b	#15,12(a0)		; speed en 16-n donc <16
	bhi.s	.ohno
	tst.b	13(a0)			; � priori toujours 0
	bne.s	.ohno
	tst.b	$8e(a0)			; taille seq (peut pas �tre 0 ou >7f)
	ble.s	.ohno
	lea	$110(a0),a1		; patt
	tst.b	d3
	beq.s	.fmt1
...
;	bhi.s	.ohno
	...
	bne.s	.ohno
; todo : v�rifier que les effets <>0 ou <>13 ne sont pas utilis�s
;.loop

; bon, �a devrait suffire...
; ok
	moveq	#0,d0
	rts
.ohno
