...
size_var	rs.b	0
	...
	lea	gfxn(pc),a1
	moveq	#39,d0			* Kick 3.0 or higher
	lob	OpenLibrary
...
.colors	dc	$0ff,$0ee,$0dd,$0cc,$0bb,$0aa,$099,$088
...
.oo
	...
	move.l	#screen2+plane,omabitmap+bm_Planes+4(a5)
	move.l	#screen2+plane*2,omabitmap+bm_Planes+8(a5)
	move.l	#screen2+plane*3,omabitmap+bm_Planes+12(a5)
	move.l	#screen2+plane*4,omabitmap+bm_Planes+16(a5)
...
wflags set wflags!WFLG_SUPER_BITMAP
